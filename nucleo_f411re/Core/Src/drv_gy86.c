...
static BOOL mpuAccRead(int16_t *accData)
{
    ...
    if (!pifImuSensor_ReadAccel2(&imu_sensor, data)) return FALSE;
    accData[0] = data[0];
    accData[1] = data[1];
    accData[2] = data[2];
    return TRUE;
...
static BOOL mpuGyroRead(int16_t *gyroData)
{
	...
	if (!pifImuSensor_ReadGyro2(&imu_sensor, data)) return FALSE;
	gyroData[0] = data[0];
	gyroData[1] = data[1];
	gyroData[2] = data[2];
	return TRUE;
...
static BOOL hmc5883lRead(int16_t *magData)
{
	...
	if (!pifImuSensor_ReadMag2(&imu_sensor, data)) return FALSE;
	magData[0] = data[0];
	magData[1] = data[1];
	magData[2] = data[2];
	return TRUE;
