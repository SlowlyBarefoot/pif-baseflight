...
static const char* hw_names = "MS5611";


bool ms5611Detect(sensorSet_t *p_sensor_set, void* p_param)
{
    bool ack = false;
    uint8_t sig;
    int i;
    ...
    pif_Delay1ms(10); // No idea how long the chip takes to power-up, but let's make it 10ms
