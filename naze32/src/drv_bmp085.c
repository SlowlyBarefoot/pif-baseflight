...
static const char* hw_names = "BMP085";
...
bool bmp085Detect(sensorSet_t *p_sensor_set, void* p_param)
{
    gpio_config_t gpio;
    ...
    pif_Delay1ms(20); // datasheet says 10ms, we'll be careful and do 20. this is after ms5611 driver kills us, so longer the better.
